...
<html>
    ...
    <div class="connection">
        <ul>
            <li class="button"><a class="whitelink" href="../../login/profile.php">Mon compte</a></li>
            <li class="button"><a class="whitelink" href="../../login/logout.php">Déconnexion</a></li>
        </ul>
    </div>
</header>
	<body>
            ...
            <div>
                <div class="clearing registerformcontainer">
                    ...
                    <h1 class="pageinfoh1">Edition du profil</h1>
                        <form action="editsubmitS.php" method="post" autocomplete="off">
                            <div>
