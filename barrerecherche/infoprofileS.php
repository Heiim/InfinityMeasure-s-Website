            ...
            <div class="clearing profilecontainer">
                            ...
                            <button class="dropbtn">Résultats</button>
                                <div class="dropdown-content">
                                    ...
                                    for ($i = 0; $i < count($idstest); $i++) {
                                        echo '<a href="results/getresultsS.php?idtest='.$idstest[$i].'">'.$descriptions[$i].'</a>';
                                    }
                                    ?>
                            </div>
                        </div>
                ...
                <div class="clearing profileinfo">
                    <table>
                        ...
                        <ul>
                            <li class="button resetpasswordbutton"><a class="whitelink" href="edit/editprofileS.php">Editer mon profile</a></li>
                        </ul>
                </div>
