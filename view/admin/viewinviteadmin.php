...
<body>
    <div class="wrapper">
        <div>
            ...
            <h1 style="margin-left: 200px; margin-top: 50px; margin-bottom: 100px;" class="pageinfoh1">Nouveau profil administrateur</h1>
                <div class="registerform">
                    <form action="index.php?action=sendadmininvite" method="post" autocomplete="off">
                        <div>
