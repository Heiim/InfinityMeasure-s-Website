...
<html>
    ...
    <div class="connection">
        <ul>
            <li class="button"><a class="whitelink" href="index.php?action=managerprofile">Mon compte</a></li>
        ...
        <div>
            <div class="clearing registerformcontainer">
                ...
                <h1 class="pageinfoh1">Edition du profil</h1>
                    <form action="index.php?action=doeditmanagerprofile" method="post" autocomplete="off">
                        <div>
