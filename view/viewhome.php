...
<body>
    <div class="banner">
        <section>
           <div class="topleftbutton">
            ...
            <div class="toprightbutton">
                    <img class ="flaglogoFr" src="public/images/FrFlag.png">
                    <img class ="flaglogoGb" src="public/images/GBFlag.png">
                    <a class="buttonright" href="index.php?action=login"> Déjà membre ?</a>
            </div>
        ...
        <section>
            <div class="title">
                <h2> Nos dispositifs et tests</h2>
